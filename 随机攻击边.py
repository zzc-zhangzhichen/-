...
def random_attack(G,times):
    ...
    #print("完整网络效率为 "+str(global_efficiency(G)));
    while times>0 and len(graph)>0:
        ...
        print("去除"+str(steps)+"个边时效率为: "+str(eff))
        steps += 1
        times -= 1
